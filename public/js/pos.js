...
function pos_total_row() {
	...
	$("table#pos_table tbody tr").each(function () {
		...
		subtotal1 += __read_number($(this).find("input.pos_line_total"))
	});
	$("table#pos_table2 tbody tr").each(function () {
		total_quantity =
			total_quantity + __read_number($(this).find("input.pos_quantity"));
		price_total = price_total + __read_number($(this).find("input.pos_line_total"));
		subtotal2 += __read_number($(this).find("input.pos_line_total"))
	});
		...
		price_total =
			price_total + __read_number($(this).find("input.pos_line_total"));
		subtotal3 += __read_number($(this).find("input.pos_line_total"));
	});
	...
	document.querySelector("#discount_amount_2").addEventListener("keyup",(e) => {
	...
	let discount_amount_1 = document.getElementById("discount_amount_1")?.value;
	let discount1 =  parseInt(discount_amount_1?discount_amount_1:0);
	let total1 = subtotal1 - (discount1?discount1:0);
	document.getElementById("total1").innerHTML = total1;
	document.getElementById("total_1").value = total1;

	let discount_amount_2 = document.getElementById("discount_amount_2")?.value;
	let discount2 =  parseInt(discount_amount_2?discount_amount_2:0);
	let total2 = subtotal2 - (discount2?discount2:0);
	document.getElementById("total2").innerHTML = total2;
	document.getElementById("total_2").value = total2;

	let discount_amount_3 = document.getElementById("discount_amount_3")?.value;
	let discount3 =  parseInt(discount_amount_3?discount_amount_3:0);
	let total3 = subtotal3 - (discount2?discount3:0);
...
document.querySelector("#discount_amount_1").addEventListener("keyup",(e) => {
	let subtotal1 = parseInt(document.getElementById("subtotal1").innerHTML);
	let discount1 = parseInt(e.target.value)
	let total1 = subtotal1 - discount1;
	document.getElementById("total1").innerHTML = total1;
	pos_total_row();
	// console.log(e.target.value)
})
document.querySelector("#discount_amount_2").addEventListener("keyup",(e) => {
	...
	let discount2 = parseInt(e.target.value)
	let total2 = subtotal2 - discount2;
	document.getElementById("total2").innerHTML = total2;
	pos_total_row();
	// console.log(e.target.value)
})

document.querySelector("#discount_amount_3").addEventListener("keyup",(e) => {
	let subtotal3 = parseInt(document.getElementById("subtotal3").innerHTML);
	let discount3 = parseInt(e.target.value)
	let total3 = subtotal3 - discount3;
	document.getElementById("total3").innerHTML = total3;
	pos_total_row();
	// console.log(e.target.value)
})
...
function calculate_billing_details(price_total) {
	...
	let discount_amount_3 = document.getElementById("discount_amount_3")?.value;
	let discount3 =  parseInt(discount_amount_3?discount_amount_3:0);
	shown_total -= (discount1 + discount2 + discount3)
	console.log(shown_total,discount1,discount2,discount3)
