...
class ManageUserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $user_details = $request->only(['surname', 'first_name', 'last_name', 'username', 'email', 'password', 'selected_contacts','salary','contact_no']);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $user_data = $request->only(['surname', 'first_name', 'last_name', 'email', 'selected_contacts','salary','contact_no']);
