<tr class="product_row" data-row_index="{{$row_count}}">
	...
	@php
            ...
            ->category_id;
	@endphp
    <td><input type="text" class="form-control" name="products[{{$row_count}}][cost]" value="{{@num_format($product->cost)}}">
        <input type="hidden" class="form-control" name="products[{{$row_count}}][category]" value="{{($product_category_id)}}"></td>
