  ...
  <section class="sidebar">
    ...
    <li class=" {{ in_array($request->segment(1), ['roles', 'users', 'sales-commission-agents']) ? 'active active-sub' : '' }}">
      <a href="#">
        ...
        <span class="link-name">Ecommerce</span>
      ...
      <ul class="sub-menu">
        ...
        <li class="{{ $request->segment(1) == 'ecom-sells' ? 'active' : '' }}">
          <a href="{{route('orders.sell')}}">
            <i class="fa fa-arrow-circle-up"></i>
            <span class=""> Ecommerce Sells</span>
          </a>
        </li>
        <li class="{{ $request->segment(1) == 'orders' ? 'active' : '' }}">
          <a href="{{route('orders.view')}}">
            <i class="fa fa-arrow-circle-up"></i>
            <span class=""> Orders ({{\App\Order2::where("delivery_status","pending")->get()->count()}})</span>
          </a>
        </li>
        <li class="{{ $request->segment(1) == 'orders' ? 'active' : '' }}">
          <a href="{{env('APP_URL')}}/orders?delivery_status=cancelled&date=&search=">
            <i class="fa fa-arrow-circle-up"></i>
            <span class="">Cancelled Orders</span>
          </a>
        </li>
    ...
    <li class=" {{ in_array($request->segment(1), ['variation-templates', 'products', 'labels', 'import-products', 'import-opening-stock', 'selling-price-group', 'brands', 'units', 'categories']) ? 'active active-sub' : '' }}" id="tour_step5">
      <a href="#" id="tour_step5_menu">
        <i class="fa fa-cubes"></i>
        <span class="link-name">Hospital</span>
      ...
      <ul class="sub-menu">
        ...
        @endcan
        @can('product.view')
        <li class="{{ $request->segment(1) == 'doctors' && $request->segment(2) == '' ? 'active' : '' }}"><a href="{{action('DoctorController@index')}}">
        ...
        <li class="{{ $request->segment(2) == 'doctors' ? 'active' : '' }}">
          <a href="{{action('DoctorController@getDoctorSellReport')}}"><i class="fa fa-money"></i>Doctor Sell Report</a>
        </li>
        @endcan
      </ul>
    </li>
